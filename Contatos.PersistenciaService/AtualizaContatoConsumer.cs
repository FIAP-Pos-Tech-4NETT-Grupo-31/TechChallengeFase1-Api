...
{
    public class AtualizaContatoConsumer : BackgroundService
    {
        ...
        public AtualizaContatoConsumer(IServiceProvider serviceProvider, IConfiguration configuration)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            using (var channel = connection.CreateModel())
            {
                ...
                channel.BasicConsume(queue: "AtualizaContatoQueue", autoAck: true, consumer: consumer);
